...
interface HealthAssessmentOptionScreenProps {
  onTakeAssessment: () => void
  onSkip: () => void
}

export function HealthAssessmentOptionScreen({ onTakeAssessment, onSkip }: HealthAssessmentOptionScreenProps) {
        ...
        <div className="flex-1 flex flex-col justify-center py-4">
          ...
          >
            ...
            >
              ...
              >
                <Icon name="clipboardList" className="w-8 h-8 text-[var(--ds-text-inverse)]" />
              </div>
            </motion.div>
