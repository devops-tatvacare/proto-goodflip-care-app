...
export function AssessmentCompleteScreen({ onSeePlans, onTakeToApp }: AssessmentCompleteScreenProps) {
  const completionDetails = [
    "Personalized diet plan ready",
        ...
        <div className="flex-1 flex flex-col justify-center py-4">
          ...
          >
            ...
            >
              ...
              >
                <Icon name="checkCircle" className="w-8 h-8 text-[var(--ds-text-inverse)]" />
              </div>
            </motion.div>
