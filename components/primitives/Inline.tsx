...
export type InlineGap = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | '5xl'
...
export interface InlineProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /**
   * Whether the inline container should wrap its children
   */
  wrap?: boolean
  
  /**
   * Whether the inline container should fill available height
   */
  fullHeight?: boolean
  
  /**
   * Whether the inline container should fill available width
   */
  fullWidth?: boolean
}
...
/**
 * Inline - A horizontal flex container with consistent gap spacing
 */
